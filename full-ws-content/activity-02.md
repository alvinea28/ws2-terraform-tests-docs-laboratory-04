# Activity 02 — Observe the detector and narrow the example rule
...
**2026-09-08 — Cycle A: recorded verified; Cycle B: recorded verified.** Both private simulations recorded the narrowed `10.42.1.0/24` sample and completed the full checker, including the isolated detector and corrected-sample fixture. The shipped validators were not weakened; the detector's temporary expected error is not a live security failure.

Whole-lab Node and mocked case/fixture totals are not per-activity counts; do not add repeated original/repaired seed runs again. See the [simulation record and coverage limits](simulation.md).
